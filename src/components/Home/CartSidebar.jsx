        ...
        <>
            ...
            >
                <div className="flex justify-between items-center border-b pb-3">
                    <h2 className="text-h4 font-bold text-heading">
                        My Cart ({cart.length})
                    </h2>
                    <button
                ...
                <div className="w-full bg-gray-200 rounded-full flex items-center relative mt-8 h-6 overflow-hidden">
                    ...
                    <motion.div
                        ...
                        style={{
                            background: "linear-gradient(to right, #4ade80, #22c55e, rgb(93, 114, 39))",
                        }}
                        animate={{ x: ["-100%", "100%"] }}
                    ...
                    {cart.map((item) => (
                        <div key={item.id} className="flex items-center py-4">
                            ...
                            <div className="flex-1 ml-4">
                                <h3 className="text-h6 font-bold text-heading">{item.name}</h3>
