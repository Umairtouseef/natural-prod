        ...
        <footer className="bg-theme-gradient text-white px-8 py-8 ">
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-center ">
                ...
                <div>
                    ...
                    <p className="text-white text-p leading-relaxed mt-2">Call Us: 123-456-7898</p>
                    <p className="text-white text-p leading-relaxed mt-2">Email Us: Support@Marijuana.com</p>
