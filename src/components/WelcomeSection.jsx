...
const WelcomeSection = () => {
    ...
    <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
                <div
                    className="relative w-full h-64 bg-cover bg-center rounded-lg transition-transform duration-300 hover:scale-105 hover:opacity-90 cursor-pointer"
                    style={{
                        backgroundImage:
                            "url('https://themes.pixelstrap.com/multikart/assets/images/marijuana/banner/1.png')",
                    }}
                ></div>
                ...
                <div
                    ...
                    style={{
                        backgroundImage:
                            "url('https://themes.pixelstrap.com/multikart/assets/images/marijuana/banner/2.png')",
                    }}
                ></div>
            </div>
        </section>
